...
class FormTransaksi {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (pemilikrekening_booking != null) {
      data['pemiliktujuan_booking'] = pemilikrekening_booking!;
    }
  ...
  FormData convertoFormData() {
    ...
    if (pemilikrekening_booking != null) {
      formData.fields
          .add(MapEntry('pemiliktujuan_booking', pemilikrekening_booking!));
    }
    if (nominal_booking != null) {
      formData.fields.add(MapEntry('nominal_booking', nominal_booking!));
    }

    if (attachment_transaction!.path != null &&
        attachment_transaction!.path != '' &&
